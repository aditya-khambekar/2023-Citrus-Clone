 ...
 */
public class NewDutyCycleEncoder implements Sendable, AutoCloseable {
    ...
    public NewDutyCycleEncoder(int channel, double fullRange, double expectedZero) {
     ...
     */
    @SuppressWarnings("this-escape")
    public NewDutyCycleEncoder(DutyCycle dutyCycle, double fullRange, double expectedZero) {
     ...
     */
    @SuppressWarnings("this-escape")
    public NewDutyCycleEncoder(DigitalSource source, double fullRange, double expectedZero) {
        m_ownsDutyCycle = true;
     ...
     */
    @SuppressWarnings("this-escape")
    public NewDutyCycleEncoder(int channel) {
     ...
     */
    @SuppressWarnings("this-escape")
    public NewDutyCycleEncoder(DutyCycle dutyCycle) {
     ...
     */
    @SuppressWarnings("this-escape")
    public NewDutyCycleEncoder(DigitalSource source) {
        this(source, 1.0, 0.0);
    }
